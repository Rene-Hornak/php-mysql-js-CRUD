<?php
    ...
    $stmt = $pdo->prepare($sql);
    $stmt->execute(array(':user_id' => $GET['user_id']));
...
<body>
    ...
    <form method="post">
        ...
        <input type="text" name="name" id="firstName" value="<?= htmlentities($row['name']) ?>" />

        <label for="lastName">Last Name:</label>
        <input type="text" name="surname" id="lastName" value="<?= htmlentities($row['surname']) ?>" />
        
        <label for="email">Email:</label>
        <input type="text" name="emailAddress" id="email" value="<?= htmlentities($row['emailAddress']) ?>" />
        
        <label for="headline">Headline:</label>
        <input type="text" name="subject" id="headline" value="<?= htmlentities($row['subject']) ?>" />

        <label for="summary">Summary:</label>
        <input type="text" name="abstract" id="summary" value="<?= htmlentities($row['abstract']) ?>" />
